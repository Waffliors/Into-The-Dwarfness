    ...
    private List<Integer> loadUblockedTiles (){
        List<Integer> unblockedTiles = 
                Arrays.asList( 20, 23, 24, 25, 26, 27, 28, 29, 30, 48, 49, 50,
                              ...
                              155,156,157,158,160,161,162,163,164,165,169,170,
                              171,172,173,174,176,177,178,179,180,181,182,184,
                              185,186,187,188,189,190,193,194,197,198,199,200,
                              201,202,203,204,205,206,213,214,216,217,218,219,
                              220,221,222,229,233,234,235,237,238,240,241,242,
                              248,250,254,258,259,266,267,269,270,274,275,276,
                              277,278,282,283,284,285,286,304,305);
    ...
    public void stageCreator(int ref) {
        ...
        if (actualStage == 4) {
            this.floorMap = new int[][]{
                ...
                {  6, 142, 142, 142, 142, 142, 142, 172, 172, 142, 142, 142, 142, 142, 142,   6},
        ...
        if (actualStage == 8) {
            ...
            this.objectMap = new int[][]{
                {  6,   6,   6,   6,   6,   6,   6,   6,   6,   6,   6,   6,   6,   6,   6,   6},
                {  6,   6,   6,   6,   6, 209,   6,   6,   6, 208,   6,   6,   6,   6,   6,   6},
                {  6,   6,   6, 209,   6, 225,   6,   6,   6, 224,   6, 210,   6,   6,   6,   6},
            ...
            this.wallMap = new int[][]{
                ...
                { 18,   6,   6,   6,   6,   6,   6,   6,   6,   6,   6,   6,   6,   6,   6,  16},
                { 18,   6,   6,   6,   6,   6,   6,   6,   6,   6,   6,   6,   6,   6,   6,  16},
                {112,  52,  52,  52,  52,  52,  52,  52,  52,  52,  52,  52,  52,  52,  52, 115},};          
        }
